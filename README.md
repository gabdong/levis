# Levis - Responsive WEB

## [ViewSite](http://gabdong.dothome.co.kr/levis)

***
Levis의 홈페이지를 반응형으로 제작하였습니다.

미디어쿼리를 사용하여 반응형으로 제작하였으며, jQuery플러그인을 이용하여 gnb토글 및 슬라이더를 제작하였습니다.
